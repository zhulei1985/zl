...
int UserInput(CScriptVirtualMachine* pMachine, CScriptRunState* pState)
{
	...
	CScriptEventMgr::GetInstance()->SetEventBlock(E_SCRIPT_EVENT_RUNSCRIPT, pMachine->m_nEventListIndex, true);
	CScriptEventMgr::GetInstance()->SetEventBlock(E_SCRIPT_EVENT_NETWORK_RUNSCRIPT, pMachine->m_nEventListIndex, true);
	std::cin.getline(strTemp,1024);
	CScriptEventMgr::GetInstance()->SetEventBlock(E_SCRIPT_EVENT_RUNSCRIPT, pMachine->m_nEventListIndex, false);
	CScriptEventMgr::GetInstance()->SetEventBlock(E_SCRIPT_EVENT_NETWORK_RUNSCRIPT, pMachine->m_nEventListIndex, false);
