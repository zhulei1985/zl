...
protected:
	...
	*/
	static const char* ReadName( const char* p, TIXML_STRING* name, XmlEncoding encoding );
...
public:
	...
	*/	
	...
	const char * QueryAttribute(const char * name) const;
	int  QueryAttribute(const char * name,const char *keyword[],int keycount) const;

	void QueryAttribute(const char *name,long *value) const;
	void QueryAttribute(const char *name,unsigned long *value) const;

	void QueryAttribute(const char *name,int *value) const;
	void QueryAttribute( const char * name,unsigned int *value) const;
	void QueryAttribute( const char * name,unsigned short *value) const;
	void QueryAttribute(const char *name,float *value) const;
	void QueryAttribute(const char *name,unsigned char *vlaue) const;
	void QueryAttribute(const char *name,std::string *vlaue) const;
...
public:
	...
	*/
	...
	bool LoadFile( const std::string& filename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
